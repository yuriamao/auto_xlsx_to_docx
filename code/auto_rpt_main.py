...
# 读取配置文件
config_df = pd.read_excel(r'/Users/harvin/code/自动报告产品开发-产业链@20220830/data/产业价格周报配置文件@20220829.xlsx',header=0)
# 读取数据
data_dim,data_week_df = data_process(r'/Users/harvin/code/自动报告产品开发-产业链@20220830/data/产业上中下游价格指数20220827.xlsx')
# 获取时间序列
