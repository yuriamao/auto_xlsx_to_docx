...
def find_best_match(name, ordered_group_names):
    ...
    max_common_char = ''
    max_count = 0
    for ordered_name in ordered_group_names:
        common_char = most_common_char(name + ordered_name)
        if common_char in name and common_char in ordered_name:
            count = name.count(common_char)
            if count > max_count:
                max_count = count
                max_common_char = common_char
    return max_common_char
